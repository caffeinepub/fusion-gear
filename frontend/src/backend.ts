...
export class Backend implements backendInterface {
    ...
    async createCustomerProfile(arg0: CustomerProfile): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async createServiceRecord(arg0: bigint, arg1: ServiceRecord): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.createServiceRecord(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteCustomerProfile(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteCustomerProfile(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllCustomerProfiles(): Promise<Array<[bigint, CustomerProfile]>> {
        if (this.processError) {
            try {
    ...
    async getCustomerProfile(arg0: bigint): Promise<CustomerProfile> {
        if (this.processError) {
            try {
    ...
    async getDailySalesTotal(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getDailySalesTotal();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMonthlySalesTotal(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getMonthlySalesTotal();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getServiceFrequency(): Promise<Array<[string, bigint]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getServiceFrequency();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getServiceHistoryByBikeNumber(arg0: string): Promise<Array<Invoice>> {
        if (this.processError) {
            try {
                const result = await this.actor.getServiceHistoryByBikeNumber(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getServiceRecord(arg0: string): Promise<Invoice> {
        if (this.processError) {
            try {
    ...
    async updateCustomerProfile(arg0: bigint, arg1: CustomerProfile): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateInvoiceStatus(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateServiceRecord(arg0: string, arg1: ServiceRecord): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateServiceRecord(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
